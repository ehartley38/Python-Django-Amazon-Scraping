...
def profile(request):
    if request.method == 'POST':
        u_form = UserUpdateForm(request.POST, instance=request.user) #Display current logged in users information
        ...
        u_form = UserUpdateForm(instance=request.user)  # Display current logged in users information
